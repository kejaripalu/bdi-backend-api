...
public enum SektorPeta {
    ...
    PARPOL_PEMILU_PILKADA("Partai Politik, Pemilu dan Pilkada", BidangDirektorat.IPOLHANKAM),
    GERAKAN_TERORIS_RADIKAL("Gerakan Terorisme dan Radikalisme", BidangDirektorat.IPOLHANKAM),
    PENGAWASAN_WILAYAH_TERITORIAL("Pengawasan wilayah Teritorial", BidangDirektorat.IPOLHANKAM),
